...
public class MainScreen extends javax.swing.JApplet {
    ...
    private void initComponents() {
        ...
        jPanelAlgorithmLayout.setVerticalGroup(
            jPanelAlgorithmLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPaneAlgorithm, javax.swing.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE)
        );
        ...
        jPanelReadyProcesses.setPreferredSize(new java.awt.Dimension(340, 163));
        ...
        jTextFieldPriority.setToolTipText("Digite aqui a prioridade do processo a ser criado");
        ...
        jPanelProcessesLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelProcessesLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldPriority, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(51, 51, 51)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jPanelAnimation, javax.swing.GroupLayout.DEFAULT_SIZE, 601, Short.MAX_VALUE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(134, 134, 134)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jPanelAnimation, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButtonIntroductionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIntroductionActionPerformed
        final String TEXT_BASE_INTRODUCTION = "\n" +
                                              ...
                                              "*Este software educativo trata da política \"Por Prioridade Não-Preemptiva\".\n" +
                                              "A idéia desta política é passar o controle do processador para o processo que tenha a maior prioridade (em alguns sistemas, zero é\n" +
                                              "considerado a maior prioridade, porém neste software educativo a maior prioridade será o maior inteiro).\n" +
                                              "A prioridade de um processo pode ser definida de duas formas: internamente ou externamente. Internamente, significa dizer que o sistema\n" +
                                              "operacional utiliza valores mensuráveis para definir a prioridade do processo. Utiliza-se, por exemplo, requisitos de memória, limites\n" +
                                              "de tempo, etc. Externamente: são aquelas atribuídas por critérios externos ao sistema, por exemplo, o departamento responsável pela\n" +
                                              "execução do processo, a importância do processo, etc. Neste software educativo, a prioridade é definida pelo usuário.\n\n" +
                                              "* VEJA O ALGORITMO ABAIXO";
        final String TEXT_BASE_ALGORITHM = "funcao porPrioridadeNaoPreemptiva (referência de vetor<TAD_Processo> listaDeProntos, inteiro prioridade_maxima) : TAD_Processo\n" +
                                           "inicio\n" +
                                           "    TAD_Processo processo;\n" +
                                           "    inteiro aux := 0;\n\n" +
                                           "    se (listaDeProntos não está vazia)\n" +
                                           "        para (inteiro i := 0; i <= (tamanho de listaDeProntos - 1); i++)\n" +
                                           "            se (aux < listaDeProntos.elemento(i).prioridade)\n" +
                                           "                aux := listaDeProntos.elemento(i).prioridade);\n" +
                                           "                processo := listaDeProntos.elemento(i);\n" +
                                           "                se (aux = prioridade_maxima)\n" +
                                           "                    i := tamanho de 'listaDeProntos';\n" +
                                           "                Fim se\n" +
                                           "            Fim se\n" +
                                           "        Fim para\n" +
                                           "        porPrioridadeNaoPreemptiva := processo;\n" +
                                           "        remove elemento igual a 'processo' do vetor listaDeProntos;\n" +
                                           "    Fim se\n" +
                                           "    senão\n" +
                                           "        Exibir mensagem \"Lista de processos prontos vazia!\";\n" +
                                           "        porPrioridadeNaoPreemptiva := null;\n" +
                                           "    Fim senão\n"+
                                           "fim.";
    ...
    private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStartActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Para criar um processo, digite seu tempo de burst, sua prioridade e clique em 'Criar'.\n" +
                ...
                "                                4) Passe o cursor do mouse sobre os processos prontos (Blocos Brancos) para ver informações sobre eles.", "DICA", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButtonCreateProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateProcessActionPerformed
        if( (this.jTextFieldBurstTime.getText().equals("")) || ((Integer.parseInt(this.jTextFieldBurstTime.getText()) < MINIMUM)) || ((Integer.parseInt(this.jTextFieldBurstTime.getText()) > MAXIMUM)) ){
            ...
            if( (this.jTextFieldPriority.getText().equals("")) || ((Integer.parseInt(this.jTextFieldPriority.getText()) < MINIMUM)) || ((Integer.parseInt(this.jTextFieldPriority.getText()) > MAXIMUM)) ){
                JOptionPane.showMessageDialog(null, "Digite um número inteiro entre " + MINIMUM + " e " + MAXIMUM + " para a prioridade do processo.", "ERRO", JOptionPane.ERROR_MESSAGE);
            }
            else{
                ...
                if(this.processesList.size() <= 17) {
                    ...
                    process.setPriority(Integer.parseInt(this.jTextFieldPriority.getText()));
                    ...
                    if(st != null) {
                        ...
                        if ((st.getJButtonOkNextStep().isVisible() == true) && (st.getJProgressBarExecution().isVisible() != true)) {
            ...
            this.jTextFieldPriority.setText("");
        }
    ...
    private void jButtonAlgorithmStepsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlgorithmStepsActionPerformed
        ...
        st = new AlgorithmStepsThread(this, this.jButtonAlgorithmSteps, this.jButtonReport, this.processesList, this.reportBase,
                                      ...
                                      MAXIMUM, this.jButtonOkNextStep);
        t = new Thread(st);
        t.start();
    ...
    private void jButtonReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReportActionPerformed
        ...
        for(int i = 0; i <= (this.reportBase.size() - 1); i++) {
            report += "P" + this.reportBase.elementAt(i).getId() + ": tempo de burst = " + (int)this.reportBase.elementAt(i).getLifeTime() + ";  tempo na criação = " + (int)this.reportBase.elementAt(i).getCreationTime() + ";  prioridade = " + this.reportBase.elementAt(i).getPriority() + ";\n";
        }
        
        report += "\n***\n\n";
        
        for(int i = 0; i <= (this.processesList.size() - 1); i++) {
            report += "P" + this.processesList.elementAt(i).getId() + ": tempo de burst = " + (int)this.processesList.elementAt(i).getLifeTime() + ";  tempo na criação = " + (int)this.processesList.elementAt(i).getCreationTime() + ";  prioridade = " + this.processesList.elementAt(i).getPriority() + ";\n";
        }
    ...
    public void paintProcessesList(Vector<Process> processesQueue) {
        ...
        for(int i = 0; i <= (processesQueue.size() - 1); i++) {
            ...
            if (i <= 8) {
                ...
                block.setBounds(15+((i - 9)*35), orientationAxisYSecMem + 70, 30, 30);
            }
        }
    }
