...
import manager.PriorityNonPreeAlgorithm;
...
public class AlgorithmStepsThread implements Runnable {
    ...
    public void run() {
        ...
        if (!this.processesList.isEmpty()) {
            ...
            PriorityNonPreeAlgorithm algorithm = new PriorityNonPreeAlgorithm();
            ...
            this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(0).getPriority()));
            do {
            ...
            this.jLabelShowCreationTime.setText("Prioridade em \"i\" = " + String.valueOf(this.processesList.elementAt(0).getPriority()));
            block.setText("i");
            ...
            if (positionsPossibleProcesses.size() > 1) {
                ...
                for(j = 1; j <= (positionsPossibleProcesses.size() - 1); j++) {
                    ...
                    if(positionsPossibleProcesses.elementAt(j) <= 8) {
                        ...
                        this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(i).getPriority()));
                        i++;
                        ...
                        if (positionsPossibleProcesses.elementAt(j-1) <= 8) {
                            ...
                            this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(9).getPriority()));
                            i++;
                            while (i <= (positionsPossibleProcesses.elementAt(j) - 9)) {
                                if (this.isJButtonOkClicked) {
                                    this.isJButtonOkClicked = false;
                                    block1.setBounds(15+(i*35), (orientationAxisY + 70), 30, 30);
                                    this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(i+9).getPriority()));
                                    i++;
                                }
                            }
                            this.jButtonOkNextStep.setVisible(false);
                    ...
                    this.jLabelShowCreationTime.setText("Prioridade em \"i\" = " + String.valueOf(this.processesList.elementAt(positionsPossibleProcesses.elementAt(j)).getPriority()));
            ...
            if (positionsPossibleProcesses.lastElement() < (this.processesList.size() - 1)) {
                ...
                if((this.processesList.size() - 1) <= 8) {
                    ...
                    this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(j).getPriority()));
                    j++;
                    ...
                    if (positionsPossibleProcesses.lastElement() <= 8) {
                        ...
                        while (j <= (this.processesList.size() - 10)) {
                            if (this.isJButtonOkClicked) {
                                ...
                                this.jLabelShowBurstTime.setText("Prioridade em \"j\" = " + String.valueOf(this.processesList.elementAt(j+9).getPriority()));
                                j++;
                            }
                        }
                        this.jButtonOkNextStep.setVisible(false);
            ...
            block4.setToolTipText("Tempo de burst = " + String.valueOf((int)process.getLifeTime()) + ";  Prioridade = " + String.valueOf(process.getPriority()));
